...
angular
  ...
  .config(function ($routeProvider, $authProvider, $httpProvider, $provide) {
          ...
          responseError: function (rejection) {
            ...
            angular.forEach(rejectionReasons, function (value, key) {
              if (rejection.statusText === value) {
                ...
                delete $rootScope.$storage.application_local_user;
                $auth.logout();
                var logoutMessage = {
                  status: 'ERROR',
    ...
    $authProvider.tokenPrefix = 'application_local'; // Local Storage name prefix was: satellizer
  ...
  .run(function ($rootScope, $location, $auth, $localStorage, Account, Notify) {
    ...
    if (!isAuthed) {
      ...
      if (!$rootScope.$storage.application_local_user) {
        Account.getProfile()
          .then(function (data) {
